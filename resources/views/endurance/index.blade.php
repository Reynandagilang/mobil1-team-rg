...
.event-card::before {
    ...
    width: 0; height: 100%;
    background: linear-gradient(90deg, rgba(196,229,56,0.02), transparent);
...
.event-card-accent {
    ...
    width: 3px;
    background: linear-gradient(180deg, transparent, var(--event-color, #C4E538), transparent);
}
.event-number-bg {
...
<section class="endo-hero" id="endo-hero" aria-label="Seri Ketahanan">
    ...
    <div class="absolute left-0 top-0 bottom-0 w-[3px] hidden lg:block"
         style="background:linear-gradient(180deg,transparent,#C4E538 35%,#C4E538 65%,transparent)"></div>
